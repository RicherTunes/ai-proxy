...
const SCREENSHOT_MAPPING = {
    ...
    'docs-components-keys-heatmap': { target: 'keys-heatmap.png', category: 'components' },
    'docs-components-key-cell-healthy': { target: 'key-cell-healthy.png', category: 'components' },
    'docs-components-key-cell-warning': { target: 'key-cell-warning.png', category: 'components' },
    'docs-components-model-card': { target: 'model-card.png', category: 'components' },
    'docs-components-model-list': { target: 'model-list.png', category: 'components' },
    'docs-components-trace-table': { target: 'trace-table.png', category: 'components' },
    'docs-components-log-entries': { target: 'log-entries.png', category: 'components' },
    'docs-components-circuit-indicators': { target: 'circuit-indicators.png', category: 'components' },
