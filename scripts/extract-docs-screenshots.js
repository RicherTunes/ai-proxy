...
function main() {
    console.log('🖼️  Extracting documentation screenshots...\n');
    ...
    for (const [source, info] of Object.entries(SCREENSHOT_MAPPING)) {
        ...
        for (const platform of platforms) {
            ...
            if (fs.existsSync(sourceFile)) {
                ...
                console.log(`✅ ${info.category ? info.category + '/' : ''}${info.target}.png`);
                copiedCount++;
                found = true;
                break;
            }
    ...
    console.log('\n' + '='.repeat(50));
    console.log(`✅ Copied ${copiedCount} screenshots to ${TARGET_DIR}`);
    if (missingCount > 0) {
        console.log(`⚠️  ${missingCount} screenshots not found`);
    }
