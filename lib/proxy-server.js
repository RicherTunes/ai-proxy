...
class ProxyServer {
    constructor(options = {}) {
        ...
        if (this.config.configDir && modelRoutingConfig.configFile) {
            try {
                const persistedPath = path.join(this.config.configDir, modelRoutingConfig.configFile);
    ...
    _handleDashboardAsset(req, res, url) {
        const ASSET_WHITELIST = {
            ...
            '/dashboard/css/routing.css': { file: 'dashboard/css/routing.css', contentType: 'text/css; charset=utf-8' },
