...
<head>
    ...
    <title>GLM Proxy Dashboard - Test Change</title>
...
<body>
                ...
                <div class="override-section">
                    <div class="override-section-header">
                        ...
                        <label class="use-global-checkbox">
                            <input type="checkbox" id="useGlobalMapping" checked onchange="toggleUseGlobalMapping()">
                            Use global routing
                        </label>
                    </div>
        ...
        <div class="header-section header-section--primary">
            ...
            <div class="global-search-container" id="globalSearchContainer">
                ...
                <div class="global-search-input-wrapper" id="globalSearchInputWrapper">
                    <input type="text" class="global-search-input" id="globalSearchInput" placeholder="Search..." data-testid="global-search" aria-label="Search requests" aria-controls="searchResults">
    ...
    <!-- Promoted Dock Panels (Phase 4c — inline on Requests page, no longer in drawer) -->
    <div class="dock-panels-container page-section request-tab-content page-hidden" id="dockPanelsContainer" data-belongs-to="requests" data-tab="live traces">
