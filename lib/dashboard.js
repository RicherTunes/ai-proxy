    ...
    <div class="bottom-drawer" id="bottomDrawer" data-testid="bottom-drawer">
        <div class="drawer-header" data-action="toggle-drawer">
            ...
            <div class="dock-tabs flex ml-8" style="gap:2px;" role="tablist" aria-label="Dock panels">
                <button class="dock-tab dock-tab-base active" data-dock-tab="live" data-testid="tab-live" data-action="switch-dock-tab" role="tab" aria-selected="true" aria-controls="tab-live" tabindex="0">Live <span class="tab-shortcut">1</span></button>
                <button class="dock-tab dock-tab-base" data-dock-tab="traces" data-testid="tab-traces" data-action="switch-dock-tab" role="tab" aria-selected="false" aria-controls="tab-traces" tabindex="-1">Traces <span class="tab-shortcut">2</span></button>
                <button class="dock-tab dock-tab-base" data-dock-tab="logs" data-testid="tab-logs" data-action="switch-dock-tab" role="tab" aria-selected="false" aria-controls="tab-logs" tabindex="-1">Logs <span class="tab-shortcut">3</span></button>
                <button class="dock-tab dock-tab-base" data-dock-tab="queue" data-testid="tab-queue" data-action="switch-dock-tab" role="tab" aria-selected="false" aria-controls="tab-queue" tabindex="-1">Queue <span class="tab-shortcut">4</span></button>
                <button class="dock-tab dock-tab-base" data-dock-tab="circuit" data-testid="tab-circuit" data-action="switch-dock-tab" role="tab" aria-selected="false" aria-controls="tab-circuit" tabindex="-1">Circuit <span class="tab-shortcut">5</span></button>
            </div>
