...
const { rejectNonJsonContentType } = require('../../content-type-validator');
                ...
                if (shouldPersist) {
                    ...
                    try {
                        ...
                        if (shouldPersistNormalizedConfig(configPath, currentHash)) {
                            ...
                            const EDITABLE_KEYS = ['enabled', 'defaultModel', 'tiers', 'rules', 'classifier', 'cooldown', 'logDecisions', 'failover', 'shadowMode', 'glm5', 'complexityUpgrade'];
